<!-- ============================================================
  BEFORE YOU PASTE, use Find & Replace:
    YOUR_GITHUB_USERNAME  ->  your GitHub username
    YOUR_LINKEDIN_ID      ->  the part after linkedin.com/in/
...
<a href="https://linkedin.com/in/YOUR_LINKEDIN_ID"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn"/></a>
...
<a href="https://www.geeksforgeeks.org/user/kunalkanaxvey/"><img src="https://img.shields.io/badge/GeeksforGeeks-2F8D46?style=for-the-badge&logo=geeksforgeeks&logoColor=white" alt="GeeksforGeeks"/></a>
...
<img src="https://cdn.simpleicons.org/python/3776AB" width="46" height="46" title="Python" alt="Python"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/cplusplus/659AD2" width="46" height="46" title="C++" alt="C++"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/c/A8B9CC" width="46" height="46" title="C" alt="C"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/mysql/5B9BD5" width="46" height="46" title="SQL" alt="SQL"/>

<br/><br/>

<sub><b>GENERATIVE AI & MACHINE LEARNING</b></sub><br/><br/>
<img src="https://cdn.simpleicons.org/langchain/34D399" width="46" height="46" title="LangChain" alt="LangChain"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/huggingface/FFD21E" width="46" height="46" title="Hugging Face" alt="Hugging Face"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/scikitlearn/F7931E" width="46" height="46" title="scikit-learn" alt="scikit-learn"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/pandas/E70488" width="46" height="46" title="Pandas" alt="Pandas"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/numpy/4DABCF" width="46" height="46" title="NumPy" alt="NumPy"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/streamlit/FF4B4B" width="46" height="46" title="Streamlit" alt="Streamlit"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/jupyter/F37626" width="46" height="46" title="Jupyter" alt="Jupyter"/>
...
<img src="https://cdn.simpleicons.org/amazonaws/FF9900" width="46" height="46" title="AWS" alt="AWS"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/microsoftazure/0078D4" width="46" height="46" title="Azure" alt="Azure"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/docker/2496ED" width="46" height="46" title="Docker" alt="Docker"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/kubernetes/326CE5" width="46" height="46" title="Kubernetes" alt="Kubernetes"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/grafana/F46800" width="46" height="46" title="Grafana" alt="Grafana"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/prometheus/E6522C" width="46" height="46" title="Prometheus" alt="Prometheus"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/linux/FCC624" width="46" height="46" title="Linux" alt="Linux"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/githubactions/2088FF" width="46" height="46" title="CI/CD" alt="CI/CD"/>
...
<img src="https://cdn.simpleicons.org/git/F05032" width="46" height="46" title="Git" alt="Git"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/github/8B949E" width="46" height="46" title="GitHub" alt="GitHub"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/googlecolab/F9AB00" width="46" height="46" title="Google Colab" alt="Google Colab"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/vercel/94A3B8" width="46" height="46" title="Vercel" alt="Vercel"/>&nbsp;&nbsp;&nbsp;
<img src="https://cdn.simpleicons.org/render/46E3B7" width="46" height="46" title="Render" alt="Render"/>
...
### LLM Intern &nbsp;·&nbsp; PanScience Innovations LLP
<img src="https://img.shields.io/badge/Jul%202026%20--%20Present-8B5CF6?style=flat-square&labelColor=1E1B4B" alt="Jul 2026 - Present"/>
<img src="https://img.shields.io/badge/Lucknow%20%C2%B7%20Onsite-22D3EE?style=flat-square&labelColor=1E1B4B" alt="Lucknow, Onsite"/>

- Architected a centralized **observability stack** on **AWS EC2** (Prometheus, Grafana, Loki, Promtail) with Linux provisioning, scrape targets, retention policies, and secure private-subnet access via SSH port forwarding
- Designed multi-tier **Grafana dashboards and alerting** for CRM API latency, error rates, and system health, reducing manual log inspection and accelerating **MTTR**
- **Containerized** the stack with Docker and led its migration to **Azure Kubernetes Service** using Deployments, Services, ConfigMaps, PVCs, and deployment pipelines to support the organization's Kubernetes adoption

<br/>

### Machine Learning Intern &nbsp;·&nbsp; CodeAlpha
<img src="https://img.shields.io/badge/Mar%202026%20--%20Apr%202026-8B5CF6?style=flat-square&labelColor=1E1B4B" alt="Mar - Apr 2026"/>
<img src="https://img.shields.io/badge/Remote-22D3EE?style=flat-square&labelColor=1E1B4B" alt="Remote"/>

- Delivered end-to-end ML solutions: EDA, preprocessing, feature engineering, model selection, hyperparameter optimization, and evaluation with Python and scikit-learn
- **Spam Detection System** using TF-IDF and Multinomial Naive Bayes, reaching **98% precision** and **97% recall** on 5,500+ messages
- **Content-Based Movie Recommender** using CountVectorizer and cosine similarity across 5,000+ movies, documented on GitHub
...
<sub><b>HACKATHONS</b></sub><br/>
Hack-O-Fiesta, IIIT Lucknow (Apr 2024) &nbsp;·&nbsp; Smart India Hackathon (Sep 2024) &nbsp;·&nbsp; IET Lucknow College Hackathon (Jun 2024)
...
<a href="https://linkedin.com/in/YOUR_LINKEDIN_ID"><img src="https://img.shields.io/badge/Connect%20on%20LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn"/></a>
